        ...
        async.series([
            ...
            function (callback) {
                projectCreate(
                    ...
                    'Low',
                    2014,
                    [86100000, 299000000, 319000000, 426000000, 691500000, 964000000, 0],
                    [4500000, 19100000, 18700000, 20100000, 31300000, 36000000, 0],
                    '£',
                    [2.9, 6.1, 5.9, 5.9, 6.1, 5.3, 0],
                    [0, 177343, 190125, 253434, 533802, 550383, 0],
                    callback
                );
            },
            function (callback) {
